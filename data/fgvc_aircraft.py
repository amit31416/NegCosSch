...
aircraft_root = '/fs/nexus-scratch/amit314/datasets/aircraft'
...
def get_aircraft_datasets(train_transform, test_transform, train_classes=range(60),
    ...
    train_dataset_whole = FGVCAircraft(root=aircraft_root, transform=TwoCropTransform(train_transform), split='trainval')
