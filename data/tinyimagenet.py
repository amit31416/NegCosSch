...
tin_train_root_dir = '/fs/nexus-scratch/amit314/datasets/tinyimagenet/tiny-imagenet-200/train'
tin_val_root_dir = '/fs/nexus-scratch/amit314/datasets/tinyimagenet/tiny-imagenet-200/val/images'
...
def get_tiny_image_net_datasets(train_transform, test_transform, train_classes=range(20),
    ...
    train_dataset_whole = TinyImageNet(root=tin_train_root_dir, transform=TwoCropTransform(train_transform))
    ...
    test_dataset_known = TinyImageNet(root=tin_val_root_dir, transform=TwoCropTransform(test_transform))
    test_dataset_known = subsample_classes(test_dataset_known, include_classes=train_classes)

    # Get testset for unknown classes
    test_dataset_unknown = TinyImageNet(root=tin_val_root_dir, transform=TwoCropTransform(test_transform))
