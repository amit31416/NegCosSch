...
cifar_10_root = '/fs/nexus-scratch/amit314/datasets/cifar10/'
cifar_100_root = '/fs/nexus-scratch/amit314/datasets/CIFAR100/'
...
def get_cifar_100_10_datasets(train_transform, test_transform, train_classes=(0, 1, 8, 9),
    ...
    train_dataset_whole = CustomCIFAR100(root=cifar_100_root, transform=TwoCropTransform(train_transform), train=True,download=True)
...
def get_cifar_10_10_datasets(train_transform, test_transform, train_classes=range(4),
    ...
    # Init train dataset and subsample training classes
    train_dataset_whole = CustomCIFAR10(root=cifar_10_root, transform=TwoCropTransform(train_transform), train=True,download=True)
    train_dataset_whole = subsample_classes(train_dataset_whole, include_classes=train_classes)
